...
> â¨ **Note:** You can download the Sketch files from the official product page.
...
* [noUiSlider by LÃ©on Gersen (WTFPL License)](https://refreshless.com/nouislider/download/)
